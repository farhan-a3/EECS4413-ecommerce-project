...
- `backend/` – Node.js + Express **(JavaScript)** REST API using **Prisma** (SQLite via `dev.db`)
- `frontend/` – React (Vite) **(JavaScript)** single-page app that communicates with the backend API
